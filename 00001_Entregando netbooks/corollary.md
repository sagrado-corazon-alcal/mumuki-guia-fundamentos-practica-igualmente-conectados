¿Estás pensando que _"este procedimiento no sirve para nada, lo único que hace es usar `PonerN`"_? No, no y no, este procedimiento es (quizás) uno de los más importantes que escribiste hasta ahora.
